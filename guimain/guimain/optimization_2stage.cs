...
namespace guimain
{
    ...
    public class optimization_2stage
    {
        //List<beam>[,] beamarray;
        ...
        public string ldfilepath1, ldfilepath2, ldfilepath1_4level, ldfilepath2_4level, ldfilenewpath1, ldfilenewpath2, outputpath;
        ...
        string roi_xy;
        public optimization_2stage(tiffimage tiffimg, ldconfig ldconfig1, ldconfig ldconfig2, string outputpath, string beamfilepath, string ldfilepath1, string ldfilepath2, string roi_xy, float threshold, float displacement, int maxcc = int.MaxValue, int totalnum = int.MaxValue)
        {
            ...
            ldfilepath1_4level = outputpath + roi_xy + "_LE1_2stage_4level_org.LD";
            ldfilepath2_4level = outputpath + roi_xy + "_LE2_2stage_4level_org.LD";
            //ldfilenewpath1 = outputpath + "_LE1_2stage_4level_opt.LD";
            //ldfilenewpath2 = outputpath + "_LE2_2stage_4level_opt.LD";

            if (roi_xy != "")
            {
                ldfilenewpath1 = outputpath + tiffimg.imgfilename + roi_xy + "_LE1_2stage_4level_opt.LD";
                ldfilenewpath2 = outputpath + tiffimg.imgfilename + roi_xy + "_LE2_2stage_4level_opt.LD";

            }
            else
            {
                ldfilenewpath1 = outputpath + tiffimg.imgfilename + "_LE1_2stage_4level_opt.LD";
                ldfilenewpath2 = outputpath + tiffimg.imgfilename + "_LE2_2stage_4level_opt.LD";
            }
        ...
        //    int toffset = t0 + (int)(ldystart / cnt_scale + 0.5), ldoffset;
        //    byte[] buffer = new byte[4000];
        //    beam b;
        //    BitArray bits;
        //    byte facet = (byte)(toffset % 8);
        ...
        //    toffset = t0 + (int)(ldystart / cnt_scale + 0.5);
        //    facet = (byte)(toffset % 8);
        //    if (facet == 0)
        //        facet = 8;
        ...
        //    if (expandldscale == 2)
        //        verifyimg.writearray(ldarray0, optoutputfolder + "optld_2stage", tiffimg.imgps);
        ...
        //    ldset tld = readld(xlefttop, ylefttop, xrightbottom, yrightbottom);//resolution = 0.125um

        //    dosageset d = readdosage(xlefttop, ylefttop, xrightbottom, yrightbottom, this.beamfile1path, this.beamfile2path);//resolution = 0.125um,use tld
        //    //float[,] d = new float[0, 0];
        //    targetset target = readtarget(xlefttop, ylefttop, xrightbottom, yrightbottom);//resolution = 0.125um
        //    //ldset tldfull = readld(xlefttop, ylefttop, xrightbottom, yrightbottom, expandscale);//resolution = 0.125um
        //    //if (!Directory.Exists(optoutputfolder))
        //    //    Directory.CreateDirectory(optoutputfolder);
        //    //verifyimg.writearray(tldfull.array, optoutputfolder + "orgld_total_1stage");
        //    //verifyimg.writearray(d.array, optoutputfolder + "orgd_total_1stage");
        //    //verifyimg.writearray(target.array, optoutputfolder + "targetroi_total_1stage");
        ...
        //    {
        //        optset optset100 = optimize_total_test(xlefttop, ylefttop, xrightbottom, yrightbottom, this.beamfile1path, this.beamfile2path, 100);
        //        optset optset66 = optimize_total_test(xlefttop, ylefttop, xrightbottom, yrightbottom, this.beamfile1path66, this.beamfile2path66, 66);
        //        optset optset33 = optimize_total_test(xlefttop, ylefttop, xrightbottom, yrightbottom, this.beamfile1path33, this.beamfile2path33, 33);
        //        optset optset0 = new optset();
        //        string beamfile1path = "", beamfile2path = "";
        //        if (optset100.lossdiff >= optset66.lossdiff && optset100.lossdiff >= optset33.lossdiff)
        //        {
        //            optset0 = optset100;
        //            beamfile1path = this.beamfile1path;
        //            beamfile2path = this.beamfile2path;
        //            beamonlevel = 3;
        //        }
        //        else if (optset66.lossdiff >= optset100.lossdiff && optset66.lossdiff >= optset33.lossdiff)
        //        {
        //            optset0 = optset66;
        //            beamfile1path = this.beamfile1path66;
        //            beamfile2path = this.beamfile2path66;
        //            beamonlevel = 2;
        //        }
        //        else if (optset33.lossdiff >= optset100.lossdiff && optset33.lossdiff >= optset66.lossdiff)
        //        {
        //            optset0 = optset33;
        //            beamfile1path = this.beamfile1path33;
        //            beamfile2path = this.beamfile2path33;
        //            beamonlevel = 1;
        //        }
        //        tld = optset0.tld;
        //        d = optset0.d;
        //        Array.Copy(optset0.d.array, d.array, optset0.d.array.Length);
        //        target = optset0.target;
        //        loss = optset0.loss;
        //        List<int> losshistory = optset0.losshistory;
        //        string optoutputfolder = outputpath + "optimization\\";

        //        if (loss.lossvalue > totalnum_criterion)
        //        {
        //            //losshistory.Add(loss.lossvalue);
        //            int rangex = 8, rangey = 4, rangescale = 0, omaxiter = iniomaxiter, totalcnt = 1;
        ...
        //public optset optimize_total_test(int xlefttop, int ylefttop, int xrightbottom, int yrightbottom, string beamfile1path, string beamfile2path, int beamlevel)
        //{
        //    hdf5 verifyimg = new hdf5();
        //    roirownum = yrightbottom - ylefttop + 1;
        //    roicolnum = xrightbottom - xlefttop + 1;
        ...
        //    {
        //        losshistory.Add(loss.lossvalue);
        //        int rangex = 12, rangey = 6, rangescale = 0, omaxiter = iniomaxiter, totalcnt = 1;
        //        float proportion = (float)iniproportion, tabuproportion = 0;
        //        bool optimized = true, stop = false;
        //        int nonoptx = 0, nonopty = 0, distancex, distancey;
        //        byte[,] target0, zloss0;
        ...
        //        int testiter = 100;
        //        if (loss.lossposx.Count() < testiter)
        //            testiter = loss.lossposx.Count();
        //        //while (!stop && loss.lossposx.Count != 0)
        //        {
        //            for (int pos = 0; pos < testiter; ++pos)
        //            {
        //                k = loss.lossposy[pos];
        //                f = loss.lossposx[pos];
        ...
        //        //lossset loss_opt = computeloss(d_opt, target);//first loss value of zloss
        //        //verifyimg.writearray(tldfullnew.array, optoutputfolder + "optld_total_1stage");
        //        //verifyimg.writearray(d.array, optoutputfolder + "optd_total_1stage");
        //        //outputlist(losshistory, optoutputfolder + "losshistory_total_1stage");
        //        //verifyimg.writearray(d_opt.array, optoutputfolder + "optd2_total_1stage");
        //    }

        //    optset optresult = new optset();
        //    optresult.loss = loss;
        //    optresult.target = target;
        //    optresult.tld = tld;
        //    optresult.d = d;
        //    Array.Copy(d.array, optresult.d.array, d.array.Length);
        //    optresult.losshistory = losshistory;
        //    optresult.lossdiff = losshistory[0] - losshistory[losshistory.Count() - 1];
        ...
        public int[] optimize_maxcc(int xlefttop, int ylefttop, int xrightbottom, int yrightbottom)
        {
            ...
            opt_para.ldfilepath1_4level =ldfilepath1_4level;
            opt_para.ldfilepath2_4level = ldfilepath2_4level;
            optimization_funcation opfunction = new optimization_funcation(opt_para);

            ldset tld = opfunction.readld(xlefttop, ylefttop, xrightbottom, yrightbottom,"2");//resolution = 0.125um
            //ldset tldfull = readld(xlefttop, ylefttop, xrightbottom, yrightbottom, expandscale);//resolution = 0.125um
            dosageset d = opfunction.readdosage(xlefttop, ylefttop, xrightbottom, yrightbottom, this.beamfile1path, this.beamfile2path);//resolution = 0.125um,use tld
            //float[,] d = new float[0, 0];
            ...
            {
                optset optset100 = opfunction.optimize_maxcc_test(xlefttop, ylefttop, xrightbottom, yrightbottom, this.beamfile1path, this.beamfile2path, 100);
                optset optset66 = opfunction.optimize_maxcc_test(xlefttop, ylefttop, xrightbottom, yrightbottom, this.beamfile1path66, this.beamfile2path66, 66);
                optset optset33 = opfunction.optimize_maxcc_test(xlefttop, ylefttop, xrightbottom, yrightbottom, this.beamfile1path33, this.beamfile2path33, 33);
                optset optset0 = new optset();
                string beamfile1path = "", beamfile2path = "";
                if (optset100.lossdiff >= optset66.lossdiff && optset100.lossdiff >= optset33.lossdiff)
                {
                ...
                opt_para.beamonlevel = beamonlevel;
                tld = optset0.tld;
                d = optset0.d;
                Array.Copy(optset0.d.array, d.array, optset0.d.array.Length);
                target = optset0.target;
                loss = optset0.loss;
                List<int> losshistory = optset0.losshistory;
                List<int> cchistory = optset0.cchistory;
                //ldset tld = readld(xlefttop, ylefttop, xrightbottom, yrightbottom);//resolution = 0.125um
                //ldset tldfull = readld(xlefttop, ylefttop, xrightbottom, yrightbottom, expandscale);//resolution = 0.125um
                ...
                //if (!Directory.Exists(optoutputfolder))
                //    Directory.CreateDirectory(optoutputfolder);
                //verifyimg.writearray(tldfull.array, optoutputfolder + "orgld_maxcc_1stage");
                //verifyimg.writearray(d.array, optoutputfolder + "orgd_maxcc_1stage");
                //verifyimg.writearray(target.array, optoutputfolder + "targetroi_maxcc_1stage");
                ...
                ldset tldfullnew = opfunction.readld_4level_opt(xlefttop, ylefttop, xrightbottom, yrightbottom,"2", expandscale);//resolution = 0.125um
        ...
        //    int t0 = Math.Min(ldconfig1.ymin, ldconfig2.ymin);
        //    int space = Math.Max(ldconfig1.ymax, ldconfig2.ymax) - Math.Min(ldconfig1.ymin, ldconfig2.ymin);

        //    //byte[,] output1 = new byte[(t0 + space + tiffimg.height) * 1000, 4];

        //    int toffset = t0 + tld.ldystart, ldoffset;
        //    byte[] buffer = new byte[4000];
        ...
        //                //while (ldfile.Read(buffer, 0, 4000) > 0)
        //                for (int t = toffset; t <= (tld.ldyend - tld.ldystart + space) + toffset; ++t)
        //                {
        //                    if (ldfile.Read(buffer, 0, 4000) > 0)
        //                    {
        //                        //if (!buffer.All(x => x == 0))//test if all values are empty
        ...
        //                    //while (ldfile.Read(buffer, 0, 4000) > 0)
        //                    for (int t = toffset; t <= ((ldyend - ldystart + ydistance) / cnt_scale + 0.5) + toffset; ++t)
        //                    {
        //                        if (ldfile.Read(buffer, 0, 4000) > 0)
        //                        {
        //                            //if (!buffer.All(x => x == 0))//test if all values are empty
